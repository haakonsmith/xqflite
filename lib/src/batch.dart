...
//   Batch(this.database) : batch = StringBuffer();
...
//     await database.client!.batch(batch.toString());
...
//     batch.write(buildUpdateStatement(table.name, values, query), positional: values.values.toList() + (query.valuesOrNull ?? []));
//     batch.writeln(";");
